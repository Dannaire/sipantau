...
<Navbar />
      ...
      {/* Main Content */}
      <main className="p-10">
        <h1 className="text-6xl text-center mb-12 text-gray-800"><span className="font">ISIKAN </span><span className="font-bold">DATA</span> </h1>

        <div className="max-w-4xl mx-auto space-y-8">
          {/* Komoditas Button */}
          <div
            onClick={() => router.push('/input-komoditas')}
            className="bg-gradient-to-r from-[#456882] via-[#a5bfcc] to-[#456882] cursor-pointer transition-colors rounded-3xl p-6 flex justify-between items-center"
          >
          ...
          <div
            ...
            className="bg-gradient-to-r from-[#456882] via-[#a5bfcc] to-[#456882] hover:bg-slate-700 cursor-pointer transition-colors rounded-3xl p-6 flex justify-between items-center"
          >
            ...
            <span className="text-white text-2xl"><HiArrowRight size={20} color="white" /></span>
                    ...
                    <div
            onClick={() => router.push('/input-harga-pasar')}
            className="bg-gradient-to-r from-[#456882] via-[#a5bfcc] to-[#456882] hover:bg-slate-700 cursor-pointer transition-colors rounded-3xl p-6 flex justify-between items-center"
          >
        ...
        {/* Back Button */}
        <div className="mt-12 pl-12 md:pl-20">
