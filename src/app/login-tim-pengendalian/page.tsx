...
export default function LoginTimPenanggulangan() {
  ...
  const handleLogin = () => {
    if (email && password) {
      router.push('/dashboard-tim-pengendalian')
    }
  }
...
>
      {/* Header */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-white rounded-b-[65px] px-6 flex items-center justify-center shadow-md w-[50%] sm:w-[30%] md:w-[20%] lg:w-[15%] xl:w-[12%] h-24 transition-all duration-300">
        <img
    ...
    <div className="w-full flex justify-start mt-20 pl-24">
      ...
      <div className="bg-yellow-500 h-10 sm:h-12 w-full sm:w-[90%] md:w-[70%] lg:w-[60%] xl:w-[60%] mx-auto rounded-b-3xl relative -mt-4 z-0 transition-all duration-300"></div>
    </main>
  )
}
